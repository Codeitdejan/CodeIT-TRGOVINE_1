...
{
    public partial class repFaktura2 : Form
    {
        ...
        string nazivDokumenta = "0";
        private ReportParameter p21;

        private string avio_registracija = "0", avio_tip_zrakoplova = "0", avio_maks_tezina_polijetanja = "0";
        ...
        private void LoadFunkcija()
        {
            ...
            this.reportViewer2.LocalReport.EnableExternalImages = true;
            this.reportViewer2.LocalReport.SetParameters(new ReportParameter[] { p1, p2, p3, p4, p5, p6, p8, p9, p10, p11, p18, p19, p20, p21, p22 });
        }
...
imeTablica[0], broj, poslovnica, naplatni);
            ...
            if (classSQL.remoteConnectionString == "")
            {
                ...
                //nazivDokumenta = dSRpodaciTvrtke.Tables[0].Rows[0]["ime_poslovnice"].ToString();
            }
            else
            {
                classSQL.CeAdatpter(sql1).Fill(dSRpodaciTvrtke, "DTRpodaciTvrtke");
            ...
            reportViewer2.LocalReport.DisplayName = "Racun-" + dSFaktura.Tables[0].Rows[0]["broj_racuna"].ToString() + "-" + datum_.ToString("dd-MM-yyyy") + "";
        }
        ...
        private void FillFaktura(string broj, string[] imeTablica)
        {
            ...
            string sql = "SELECT " +
                ...
                " partners.adresa AS kupac_adresa," +
                " partners.id_grad AS id_kupac_grad," +"partners.email,"+
                " partners.id_partner AS sifra_kupac," +
                " partners.napomena AS napomena_tvrtka," +
                " zemlja.zemlja AS kupac_drzava, " +
                " ziro_racun.ziroracun AS zr," +
            ...
            reportViewer2.LocalReport.DisplayName = "Faktura-" + dSFaktura.Tables[0].Rows[0]["broj_fakture"].ToString() + "-" + datum_.ToString("dd-MM-yyyy") + "";
            //nazivDokumenta = dSRpodaciTvrtke.Tables[0].Rows[0]["ime_poslovnice"].ToString();
...
where {0}.broj_fakture = '{1}' AND {0}.id_ducan = '{2}' AND {0}.id_kasa = '{3}';",
    imeTablica[0], broj, poslovnica, naplatni);
            ...
            this.reportViewer2.LocalReport.EnableExternalImages = true;
            this.reportViewer2.LocalReport.SetParameters(new ReportParameter[] { p7 });
        ...
        private void FillPonude(string broj, string[] imeTablica, string imeBrojPonude, string imeGodinaPonude)
        {
            ...
            if (samoIspis)
            {
                reportViewer2.LocalReport.DisplayName = "Ponuda-" + dSFaktura.Tables[0].Rows[0]["broj_fakture"].ToString() + "-" + datum_.ToString("dd-MM-yyyy") + "";
            }
            else
            {
                reportViewer2.LocalReport.DisplayName = "Ponuda-" + dSFaktura.Tables[0].Rows[0]["broj_ponude"].ToString() + "-" + datum_.ToString("dd-MM-yyyy") + "";
            }
        }
        ...
        private void FillOtpremnicu(string broj, string skladiste)
        {
            ...
            PostaviPodatkeOBanci(ref dSRpodaciTvrtke, ref dSFaktura);
            DateTime datum_ = Convert.ToDateTime(dSFaktura.Tables[0].Rows[0]["datum"].ToString());
            reportViewer2.LocalReport.DisplayName = "Otpremnica-" + dSFaktura.Tables[0].Rows[0]["broj_otpremnice"].ToString() + "-" + datum_.ToString("dd-MM-yyyy") + "";
        }
        ...
        private void FillIFB(string broj)
        {
            ...
            PostaviPodatkeOBanci(ref dSRpodaciTvrtke, ref dSFaktura);
            DateTime datum_ = Convert.ToDateTime(dSFaktura.Tables[0].Rows[0]["datum"].ToString());
            reportViewer2.LocalReport.DisplayName = "IFB-" + dSFaktura.Tables[0].Rows[0]["broj"].ToString() + "-" + datum_.ToString("dd-MM-yyyy") + "";
        }
        ...
        private void FillRNS(string broj)
        {
            ...
            PostaviPodatkeOBanci(ref dSRpodaciTvrtke, ref dSFaktura);
            DateTime datum_ = Convert.ToDateTime(dSFaktura.Tables[0].Rows[0]["datum"].ToString());
            reportViewer2.LocalReport.DisplayName = "RadniNalog-" + dSFaktura.Tables[0].Rows[0]["broj"].ToString() + "-" + datum_.ToString("dd-MM-yyyy") + "";
        }
